...
Compilación de producción correcta y 195 pruebas automáticas aprobadas, incluidas permisos reales en PostgreSQL de prueba, aislamiento entre restaurantes, exportaciones, invitaciones y cobertura de textos estáticos. No se ejecutó SQL ni se modificó el sitio en producción. Falta la comprobación visual en sus dispositivos.
