...
export function MobileComingSoon() {
  ...
  return <section className="mobileComingSoon" translate="no" aria-label={en ? "Mobile apps coming soon" : "Aplicaciones móviles próximamente"}>
    <h2>{en ? "UnoMesa, wherever you are" : "UnoMesa, donde usted esté"}</h2>
    ...
    <p>{en ? "You can already use UnoMesa in your phone's browser." : "Ya puede utilizar UnoMesa desde el navegador de su teléfono."}</p>
  </section>;
}
