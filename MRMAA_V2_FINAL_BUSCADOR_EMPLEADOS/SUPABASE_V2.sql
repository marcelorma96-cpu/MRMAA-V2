...
create table if not exists public.v2_reservations (
 ...
 client_name text not null, phone text not null default '', event_date date not null, event_time time, area text not null default '', guests integer,
 ...
 total numeric(12,2) not null default 0, deposit numeric(12,2),
 payment_method text not null default '', balance numeric(12,2) not null default 0,
