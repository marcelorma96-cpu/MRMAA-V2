...
export function Dashboard({
  ...
  const tutorialSteps = useMemo(() => {
    const steps: { tab?: Tab; title: string; text: string }[] = [
      ...
      { tab: "schedules", title: "Horarios", text: "Organice empleados por área, asigne horarios y comidas, copie patrones y trabaje con varios empleados. El cuadro de selección puede minimizarse; Excel e Imprimir utilizan el rango de fechas seleccionado." },
    ];
    ...
    return steps;
  }, [isAdmin, canManageQuoteProducts]);
  useEffect(() => {
            ...
            <div className="helpContent">
              <section>
                ...
                <div className="permissionTable">
                  ...
                  <div><strong>Gerente</strong><span>Crear y modificar reservaciones, clientes, cotizaciones, horarios, menús y productos. Sin reportes, usuarios ni configuración administrativa.</span></div>
                  <div><strong>Operación</strong><span>Crear y modificar reservaciones, clientes, cotizaciones, menús y productos. Horarios de consulta.</span></div>
              ...
              <HelpSection title="Cotizaciones" text="Nuevo abre el formulario. Ingrese cliente, evento, productos, descuentos, propina, anticipo y método de pago. Ver abre el preview sin cambiar de sección; PDF descarga el documento completo; Editar modifica; Convertir en reserva transfiere la información y marca ambos registros como confirmados. Para eliminar una cotización convertida, elimine primero la reservación vinculada." />
              ...
              <HelpSection title="Horarios" text="Seleccione uno o varios empleados y un día o periodo. El cuadro de asignación puede minimizarse. Asigne turno, descanso, comida y notas. Generar automáticamente necesita dos semanas completas. Excel e Imprimir descargan el rango seleccionado. Gerente y Administrador pueden modificar; los demás consultan, exportan e imprimen." />
              {isAdmin && <>
