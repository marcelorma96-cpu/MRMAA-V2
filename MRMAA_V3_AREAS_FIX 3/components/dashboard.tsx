...
export function Dashboard({
  ...
  const tutorialSteps = useMemo(() => {
    const steps: { tab?: Tab; title: string; text: string }[] = [
      ...
      { tab: "reservations", title: "Seleccione un área del listado", text: "En reservaciones y cotizaciones, seleccione un área configurada. Al escribir en el buscador se selecciona automáticamente un área coincidente del listado; no se crean áreas nuevas. Revise la selección antes de guardar. Las cotizaciones pueden quedar sin área mientras se preparan; para convertirlas en reserva debe seleccionarla. El aviso de tres horas compara reservas del mismo día y área." },
...
export function Clients({
  ...
  return (
    <div className="moduleStack">
      ...
      {loadError && <p className="moduleNotice">{loadError}</p>}
