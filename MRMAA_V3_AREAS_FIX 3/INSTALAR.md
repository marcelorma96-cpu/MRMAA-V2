...
El buscador de áreas selecciona automáticamente una opción coincidente del listado al escribir. Prioriza la coincidencia exacta y después el inicio del nombre. Sin coincidencias o al borrar la búsqueda, limpia la selección. No crea nombres nuevos. Las cotizaciones pueden permanecer sin área hasta que se conviertan en reservación.
