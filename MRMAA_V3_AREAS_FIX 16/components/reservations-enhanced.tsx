...
export function ReservationsEnhanced({
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(async () => {
      ...
      if (cancelled) return;
      if (summary.error) { setNotice(userMessage(summary.error)); setLoading(false); return; }
  ...
  }, [restaurantId, refreshToken, mode, date, from, to, normalizedSearch, page, remoteVersion]);
