...
export function PlanCards({ interval, onInterval, onChoose, busy = false, current, currentInterval, signup = false, payNow = false, minimumUsers = 0, selectionDisabled = false }: {
  interval: BillingInterval; onInterval: (value: BillingInterval) => void;
  onChoose: (plan: PlanCode) => void; busy?: boolean; current?: string; currentInterval?: BillingInterval; signup?: boolean; payNow?: boolean; minimumUsers?: number; selectionDisabled?: boolean;
}) {
