...
export function SessionManager({restaurantId}:{restaurantId?:string}) {
 ...
 return <section className="moduleCard sessionManager" translate="no">
  ...
  <p className="muted">{en?'Only sessions with access are shown. Sessions expire after one hour without activity in MRMAA. The list refreshes every minute; an active session does not mean someone is online right now. Device names are approximate.':'Solo se muestran sesiones con acceso. Caducan tras una hora sin actividad en MRMAA. La lista se actualiza cada minuto; una sesión activa no significa que alguien esté conectado en ese momento. Los nombres de dispositivos son aproximados.'}</p>
  <div className="rowActions">
