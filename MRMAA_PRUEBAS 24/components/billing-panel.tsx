...
export function BillingPanel({ restaurantId }: { restaurantId: string }) {
  ...
  return <section className="moduleCard billingPanel" translate="no">
    ...
    {paymentPending && !verifying && <p className="billingPending" role="status">{en ? "We are still awaiting payment confirmation. If you were already charged, do not pay again. Refresh the status or contact support@mrmaa.com with your receipt." : "Todavía esperamos la confirmación del pago. Si ya le cobraron, no vuelva a pagar. Actualice el estado o contacte a support@mrmaa.com con su comprobante."}</p>}
