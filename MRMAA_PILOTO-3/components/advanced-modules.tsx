    ...
    <div className="settingsLayout">
      ...
      {tab === "usuarios" ? (
        ...
        <section className="moduleCard settingsPanel">
          ...
          {!catalogsOnly && <button className="primary settingsSave" onClick={save}>
