...
create table if not exists public.v2_quotes (
 ...
 subtotal numeric(12,2) not null default 0, total numeric(12,2) not null default 0, deposit numeric(12,2) not null default 0, balance numeric(12,2) not null default 0,
 customer_note text not null default '', internal_notes text not null default '', status text not null default 'borrador',
...
create table if not exists public.v2_reservations (
 ...
 total numeric(12,2) not null default 0, deposit numeric(12,2) not null default 0, balance numeric(12,2) not null default 0,
...
begin
 ...
 if rid is null then
   ...
   if rid is null then insert into public.v2_restaurants(owner_id) values(auth.uid()) returning id into rid; end if;
