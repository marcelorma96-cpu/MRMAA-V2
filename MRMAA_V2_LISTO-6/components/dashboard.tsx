...
import { ReportsModule } from "@/components/operations";
import {
  EnhancedSettings,
  MonthlySchedules,
...
export function Dashboard({
  ...
  const load = useCallback(async () => {
    ...
    setRestaurantId(id);
    const [r, c, q, i, rv, products] = await Promise.all([
      supabase
        .from("v2_restaurants")
    ...
    <div className="overlay">
      <section
        ...
        style={{
          ...
          borderTop: `8px solid ${settings.quote_accent || "#ea580c"}`,
        }}
      >
        <header>
          <div>
        ...
        <footer>
          ...
          <button
            className="primary"
            onClick={() => downloadQuotePdf(quote, restaurant, "GTQ", settings)}
          >
            <Download />
            Descargar PDF A4
          </button>
