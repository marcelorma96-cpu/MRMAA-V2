...
export const PLANS = [
  ...
  { code: "intermediate", name: "Intermediate", monthly: 45, annual: 450, users: 5, reports: false, schedules: true,
    es: ["Todo lo incluido en el plan Basic", "Empleados y horarios", "Hasta 5 usuarios, incluido el administrador"],
    en: ["Everything included in the Basic plan", "Employees and schedules", "Up to 5 users, including the administrator"] },
  { code: "advanced", name: "Advanced", monthly: 55, annual: 550, users: 15, reports: true, schedules: true,
    es: ["Todo lo incluido en el plan Intermediate", "Hasta 15 usuarios, incluido el administrador", "Reportes completos de eventos, anticipos, clientes y horas programadas"],
    en: ["Everything included in the Intermediate plan", "Up to 15 users, including the administrator", "Full reports on events, deposits, customers and scheduled hours"] },
] as const;
