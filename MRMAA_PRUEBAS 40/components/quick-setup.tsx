  ...
  return <Modal title={en ? "Quick setup" : "Inicio rápido"} close={dismiss}>
    <div className="quickSetup" translate="no">
      {!saved ? <>
        ...
        <p>{en ? "Guide, tutorial and the UnoMesa Assistant are available whenever you need them under Help." : "El instructivo, tutorial y Asistente UnoMesa están disponibles cuando los necesite en Ayuda."}</p>
      </>}
    </div>
  </Modal>;
}
