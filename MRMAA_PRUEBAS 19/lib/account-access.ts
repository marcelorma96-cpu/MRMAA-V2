...
export type VerifiedAccount = {
  ...
  deletionScheduledAt: string | null; canWrite: boolean; trialExempt: boolean; isOwner: boolean; paidUntil: string | null;
};
...
export async function readVerifiedAccount(client: SupabaseClient, expectedUserId: string): Promise<VerifiedAccount> {
  try {
    ...
    return {
      ...
      canWrite: result.data.can_write === true, trialExempt: result.data.trial_exempt === true, isOwner: result.data.is_owner === true, paidUntil: result.data.billing_current_period_end,
    };
  } catch (error) {
