...
function QuotePreview({
  ...
  return (
    <div className="overlay">
      ...
      >
        <header className="quoteDocumentHeader">
          <div className="quoteBusiness">
            <h2>COTIZACIÓN</h2>
        ...
        <section className="quoteBillTo">
          <small>Facturar a</small>
        ...
        <section className="quoteInfo">
          <div>
            ...
            <p>
              <b>N.º de cotización:</b> {quote.quote_number}
            </p>
            <p>
              <b>Fecha de cotización:</b> {quoteDate}
            </p>
            <p>
              <b>Fecha del evento:</b> {quote.event_date}
            </p>
          </div>
          <div>
            <p>
              <b>Área y hora:</b> {quote.area || "—"} /{" "}
              {quote.event_time?.slice(0, 5) || "—"}
            </p>
            <p>
              <b>No. invitados:</b> {quote.guests}
            </p>
            <p>
              <b>No. teléfono:</b> {quote.client_phone || "—"}
            </p>
          </div>
        </section>
        ...
        <section className="quoteAcceptance">
          <span>
