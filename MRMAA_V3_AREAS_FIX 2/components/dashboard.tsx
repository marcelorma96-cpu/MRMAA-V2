...
export function Dashboard({
  ...
  const tutorialSteps = useMemo(() => {
    const steps: { tab?: Tab; title: string; text: string }[] = [
      ...
      { tab: "reservations", title: "Seleccione un área del listado", text: "En reservaciones y cotizaciones, seleccione un área configurada. El buscador solo filtra: escribir no crea ni selecciona un área. Las cotizaciones pueden quedar sin área mientras se preparan; para convertirlas en reserva debe seleccionarla. El aviso de tres horas compara reservas del mismo día y área." },
