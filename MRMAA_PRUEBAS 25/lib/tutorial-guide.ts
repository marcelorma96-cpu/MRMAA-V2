...
},
{
  ...
  "details": [
    ...
    "Se muestran usuario, correo, navegador, sistema operativo aproximado, última actividad registrada y Esta sesión. Buscar filtra nombre, correo o dispositivo. Hay 50 resultados por página. Actualizar vuelve a consultar la lista; una sesión abierta no garantiza que la persona esté conectada en ese instante. Solo aparecen sesiones que todavía tienen acceso. La lista se actualiza cada minuto. Tras una hora sin actividad en MRMAA, la sesión caduca y es necesario ingresar otra vez. Cerrar una pestaña sin cerrar sesión puede dejarla visible hasta que venza ese plazo; las sesiones vencidas no se acumulan al volver a ingresar.",
  ...
  "detailsEn": [
    ...
    "The list shows user, email, approximate browser and operating system, last recorded activity and This session. Search filters name, email or device. Results use 50-row pages. Refresh reloads the list; an open session does not prove the user is online right now. Only sessions that still have access are listed. The list refreshes every minute. After one hour without activity in MRMAA, the session expires and you must sign in again. Closing a tab without signing out may leave it visible until that deadline; expired sessions do not accumulate when signing in again.",
