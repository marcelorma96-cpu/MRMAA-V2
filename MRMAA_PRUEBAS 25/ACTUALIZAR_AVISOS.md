# MRMAA · Avisos de vencimiento · PRUEBAS 25
...
3. Suba la carpeta completa `MRMAA_PRUEBAS 25` mediante GitHub Desktop (Commit y Push).
4. Configure el Root Directory de Vercel como `MRMAA_PRUEBAS 25` y despliegue.
